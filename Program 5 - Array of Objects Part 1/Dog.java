...
public class Dog
{
   ...
   //Class Variables   
   private String dogBreed;      //Dog's breed set by user
   private String dogName;       //Dog's name set by user
   private int dogAge;           //Dog's age set by user
   ...
   //                      is instantiated.
	...
	// END Constructor
   //-----------------------------------------------------------------   
   public Dog(String breed, String name, String age)
   {
      dogBreed = breed;
      dogName = name;
